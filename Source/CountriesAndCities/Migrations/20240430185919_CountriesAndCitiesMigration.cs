...
{
    /// <inheritdoc />
    public partial class CountriesAndCitiesMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersianName = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Countries_PersianName",
                table: "Countries",
                column: "PersianName",
                unique: true,
                filter: "[PersianName] IS NOT NULL");
        }
